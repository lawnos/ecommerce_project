    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Thêm mới danh mục phụ</h1>
                    </div>
                    <div class="col-sm-6" style="text-align: right">
                        <a href="{{ url('admin/sub_category/list') }}" class="btn btn-primary">Quay lại</a>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="card card-primary">
                            <form action="" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label>Tên danh mục phụ <span style="color:red">*</span></label>
                                        <input type="text" class="form-control" name="name" required
                                            value="{{ old('name') }}" placeholder="Nhập tên danh mục phụ">
                                    </div>
