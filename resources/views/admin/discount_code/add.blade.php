                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="type" id="" required>
                                            <option {{ old('type') == 'Số lượng' ? 'selected' : '' }} value="Số lượng">
                                                Số lượng
                                            </option>
                                            <option {{ old('type') == 'Phần trăm' ? 'selected' : '' }} value="Phần trăm">
                                                Phần trăm
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="percent_amount" required
                                            value="{{ old('percent_amount') }}" placeholder="Nhập phần trăm / số lượng">
                                    </div>

                                    <div class="form-group">
                                        <label>Hạn sử dụng<span style="color:red">*</span></label>
                                        <input type="date" class="form-control" name="expire_date" required
                                            value="{{ old('expire_date') }}" placeholder="Nhập hạn sử dụng">
                                    </div>
