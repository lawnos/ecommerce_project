    ...
    <main class="main">
        ...
        <div class="container">
            <div class="page-header page-header-big text-center"
                style="background-image: url('client/assets/images/about-header-bg.jpg')">
        ...
        <div class="page-content pb-0">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mb-3 mb-lg-0">
                        <h2 class="title">Tầm nhìn của chúng tôi</h2>
                    ...
                    <div class="col-lg-6">
                        <h2 class="title">Nhiệm vụ của chúng ta</h2>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5 mb-3 mb-lg-0">
                            <h2 class="title">Chúng ta là ai?</h2>
                        ...
                        <div class="col-lg-6 offset-lg-1">
                            <div class="about-images">
                                <img src="client/assets/images/about/img-1.jpg" alt="" class="about-img-front">
                                <img src="client/assets/images/about/img-2.jpg" alt="" class="about-img-back">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <div class="brands-text">
                            <h2 class="title">Các thương hiệu thiết kế cao cấp nhất thế giới đều có mặt tại một điểm đến.
                            </h2>
                    ...
                    <div class="col-lg-7">
                        <div class="brands-display">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-6 col-sm-4">
                                    <a href="#" class="brand">
                                        <img src="client/assets/images/brands/7.png" alt="Brand Name">
                                    </a>
                                </div>

                                <div class="col-6 col-sm-4">
                                    <a href="#" class="brand">
                                        <img src="client/assets/images/brands/8.png" alt="Brand Name">
                                    </a>
                                </div>

                                <div class="col-6 col-sm-4">
                                    <a href="#" class="brand">
                                        <img src="client/assets/images/brands/9.png" alt="Brand Name">
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <h2 class="title text-center mb-4">Đội Ngũ Của Chúng Tôi</h2>

                <div class="row">
                    <div class="col-md-4">
                        <div class="member member-anim text-center">
                            <figure class="member-media">
                                <img src="client/assets/images/team/member-1.jpg" alt="member photo">
                    ...
                    <div class="col-md-4">
                        <div class="member member-anim text-center">
                            <figure class="member-media">
                                <img src="client/assets/images/team/member-2.jpg" alt="member photo">
                    ...
                    <div class="col-md-4">
                        <div class="member member-anim text-center">
                            <figure class="member-media">
                                <img src="client/assets/images/team/member-3.jpg" alt="member photo">
            ...
            <div class="about-testimonials bg-light-2 pt-6 pb-6">
                <div class="container">
                    <h2 class="title text-center mb-3">Khách hàng nói gì về chúng tôi</h2>
                    < <div class="owl-carousel owl-simple owl-testimonials-photo" data-toggle="owl"
                        ...
                        <blockquote class="testimonial text-center">
                            <img src="client/assets/images/testimonials/user-1.jpg" alt="user">
                        ...
                        <blockquote class="testimonial text-center">
                            <img src="client/assets/images/testimonials/user-2.jpg" alt="user">
